...
<form method = "post" action="">
  <div class="mb-3">
    <label for="tName<?php echo $coach['Coach_ID']; ?>" class="form-label">Coach Name</label>
    <input type="text" class="form-control" id="cName<?php echo $coach['Coach_ID']; ?>" name = "cName" value = "<?php echo $coach['Name']; ?>">
  </div>
  <div class="mb-3">
    <label for="cRecord<?php echo $team['Team_ID']; ?>" class="form-label">Coach Record</label>
    <input type="text" class="form-control" id="cRecord<?php echo $coach['Coach_ID']; ?>" name = "cRecord" value = "<?php echo $coach['Record']; ?>" >
  </div>
